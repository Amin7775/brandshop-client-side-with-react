    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <div className="md:p-2">
                ...
                <p className="mt-3 text-gray-600 px-3">Apple's Vision Pro: A game-changing augmented reality device that seamlessly merges the digital and physical worlds, offering a unique AR experience. Explore the future of technology with Apple's innovative spatial computer.</p>
                </div>
            </div>
            {/* blog 2 */}
            <div className="md:p-2">
                ...
                <p className="mt-3 text-gray-600 px-3">Intel's 13th-Gen Raptor Lake processors are a significant upgrade over the previous-gen Alder Lake CPUs. These high-end chips offer substantial power and are tailored for desktop-class computing needs, providing a substantial boost in performance.</p>
                </div>
            </div>
            {/* blog 3 */}
            <div className="md:p-2">
                ...
                <p className="mt-3 text-gray-600 px-3">Sony's new portable music players, the Walkman NW-ZX707 and NW-A306, cater to audiophiles seeking premium sound quality. Featuring advanced components like FTCAP3 high-polymer capacitors and gold reflow solder, these devices take your...</p>
                </div>
            </div>
